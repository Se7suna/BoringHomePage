...
if(!isset($_GET['shareLinkSrc'])){ // 分享链接
  echo json_encode(array(
    'resCode'=>0,
    'resData'=>array(
...
if(isset($_GET['shareLinkName'])){
  $shareLinkName = $_GET['shareLinkName'];
}
...
$userId = $_GET['userId'];
$shareLinkSrc = $_GET['shareLinkSrc'];
